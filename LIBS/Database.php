...
class Database {
  ...
  public function __construct()
  {
    ...
    // "mysql:host=127.0.0.1;dbname=adso_2696521" define el tipo de base de datos (MySQL), el host (127.0.0.1, es decir, localhost) y el nombre de la base de datos (adso_2696521).
